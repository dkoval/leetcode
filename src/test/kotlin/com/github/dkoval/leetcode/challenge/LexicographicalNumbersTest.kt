...
internal class LexicographicalNumbersTest {
    ...
    @Nested
    inner class LexicographicalNumbersRev1Test {
...
private fun LexicographicalNumbers.test(n: Int, expected: List<Int>) {
    val actual = lexicalOrder(n)
